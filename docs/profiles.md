...
content, as well as consistent creation, e.g. a form in a user interface form firmly suggests the
...
The RO-Crate profile can also lock down serialization expectations, for instance using a particular
...
licenses. Serialization of Workflow RO-Crates is restricted to ZIP archives and with a filename
...
workflows, such as those generated by [galaxy2cwl](https://github.com/workflowhub-eu/galaxy2cwl). The
...
A Workflow Testing RO-Crate is essentially a Workflow RO-Crate with additional specifications on how
...
RO-Crate for packaging **data cubes** enabling access to earth observation data, along with all the
...
The next version of the RO-Crate specification 1.2 will
